...
cl /nologo /O2 /W3 /DPLATFORM_DESKTOP /DGRAPHICS_API_OPENGL_33 /D_CRT_SECURE_NO_WARNINGS ^
   /I"%RAYLIB_SRC%" /I"%RAYLIB_SRC%\external\glfw\include" /Isrc /Isrc\ui ^
   /c src\main.c src\ui\ui.c src\win_main.c ^
...
link /nologo /subsystem:windows ^
     build\main.obj build\ui.obj build\win_main.obj build\raudio.obj build\rcore.obj build\rmodels.obj ^
